...
## Corpus Check
- 22 files · ~12,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 302 nodes · 516 edges · 18 communities (14 shown, 4 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `15a85eaa`
...
Cohesion: 0.07
Nodes (27): CGImage, NSPanel, NSRect, NSWindowController, SCNMaterial, NSCoder, CharacterWindow, .canBecomeKey (+19 more)

### Community 4 - "MinecraftCharacterNode"
Cohesion: 0.12
Nodes (19): CharacterBehaviorController, State, dragged, fall, idle, landedCrouch, lookAround, poke (+11 more)
...
Cohesion: 0.19
Nodes (11): AnyObject, NSDraggingInfo, NSDragOperation, SCNNode, SCNView, CharacterView, CharacterViewDelegate, Bool (+3 more)
...
Cohesion: 0.29
Nodes (6): [v0.1.0] - 2026-09-09, [v0.1.1] - 2026-09-09, 변경 이력, 수정, 추가, 추가

## Knowledge Gaps
- **70 isolated node(s):** `PackageDescription`, `autonomous`, `followCursor`, `chill`, `idle` (+65 more)
...
- **Why does `SkinTexture` connect `SkinTexture` to `AppController`, `SkinGalleryView`, `MinecraftCharacterNode`, `SkinDownloadError`, `AppKit`?**
  _High betweenness centrality (0.211) - this node is a cross-community bridge._
- **Why does `AppController` connect `AppController` to `PhysicsEngine`, `SkinTexture`, `MinecraftCharacterNode`, `AppKit`, `CharacterView`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `SkinGalleryView` connect `SkinGalleryView` to `SkinTexture`, `AppKit`?**
